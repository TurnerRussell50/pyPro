...
cv2.createTrackbar('hue2Lower', 'Trackbars',96,179,nothing)
cv2.createTrackbar('hue2Upper', 'Trackbars',120,179,nothing)
...
#cv2.createTrackbar('Pan','Trackbars',0,180,nothing)
#cv2.createTrackbar('Tilt','Trackbars',0,180,nothing)
