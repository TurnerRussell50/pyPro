...
cv2.createTrackbar('Stick1','Trackbars',90,180,nothing)
cv2.createTrackbar('Stick2','Trackbars',90,180,nothing)
...
while True:
    ...
    Stick1=cv2.getTrackbarPos('Stick1', 'Trackbars')
    Stick2=cv2.getTrackbarPos('Stick2', 'Trackbars')
    ...
    kit.servo[14].angle=Stick1
    kit.servo[15].angle=Stick2
